...
import com.jeffrey.websocketclient03.entity.PubSubMessage;
...
public class StompSessionManager {
    ...
    public StompSessionManager(@Qualifier("webSocketStompClient") WebSocketStompClient stompClient) throws InterruptedException {
