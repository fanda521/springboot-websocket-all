package com.example.springwebsocketserver.handler;
...
public class MyMessageHandler implements WebSocketHandler {
	 ...
	 * 关闭websocket时调用该方法
	 *
	 * @see WebSocketHandler#afterConnectionClosed(WebSocketSession,
	 * CloseStatus)
	 */
	@Override
	...
	public void handleMessage(WebSocketSession session,
		...
		String userId = this.getUserId(session);
		System.err.println("该" + userId + "用户发送的消息是：" + payload);
		message = new TextMessage("服务端已经接收到消息，msg=" + payload);
